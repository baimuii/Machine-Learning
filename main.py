...
# 训练集路径
train_path = r'D:/My thing/LIFE/Machine Learning/Data/train.csv'
data_comprehension(train_path)
"""
# 测试集路径
test_path = r'D:/My thing/LIFE/Machine Learning/Data/evaluation_public.csv'
...
def label_count(train_path, label_name):
    ...
    labeldf.to_csv(r'D:/My thing/LIFE/Machine Learning/Data/labeldf.csv', encoding='utf-8', index=False)
...
def df_concat(train_path, test_path, label):
    ...
    # 存储合并后的数据集
    totaldf.to_csv(r'D:/My thing/LIFE/Machine Learning/Data/totaldf.csv', index=False, encoding='utf-8')
    # 数值型特征
    ...
    # 分别存储
    num_var.to_csv(r'D:/My thing/LIFE/Machine Learning/Data/num_var.csv', index=False, encoding='utf-8')
    object_var.to_csv(r'D:/My thing/LIFE/Machine Learning/Data/object_var.csv', index=False, encoding='utf-8')
...
# 标签与特征之间的交叉统计
# 读取原训练集数据
traindf = pd.read_csv(r'D:/My thing/LIFE/Machine Learning/Data/train.csv')
# 需要统计的列名
need_list = ['department', 'browser_version', 'browser', 'os_type', 'os_version', 'ip_type', 'http_status_code',
             'log_system_transform', 'op_city', 'url', 'op_month']
for i in need_list:
    label_hist = px.histogram(traindf, x=i, color='is_risk', marginal='box', barmode='overlay')
    label_hist.write_html(f'D:/My thing/LIFE/Machine Learning/EDA分析/交叉统计/{i}.html')
    # notebook展示
    # label_hist.show()
print('绘图成功~')
...
# # 数值型特征
# %%time
num_var = pd.read_csv(r'D:/My thing/LIFE/Machine Learning/Data/num_var.csv')
num_fig = px.histogram(num_var, x='http_status_code', marginal='box')
num_fig.write_html(r'D:/My thing/LIFE/Machine Learning/EDA分析/数值型特征/http_status_code.html')
# # notebook展示
# num_fig.show()

# # 离散型特征
object_var = pd.read_csv(r'D:/My thing/LIFE/Machine Learning/Data/object_var.csv')
object_var.shape
for i in list(object_var.columns):
    object_hist = px.histogram(object_var, x=i, marginal='box')
    object_hist.write_html(f'D:/My thing/LIFE/Machine Learning/EDA分析/离散型特征/{i}.html')
    # notebook展示
    # object_hist.show()
print('绘图成功~')
...
# 数据清洗
# # 删除冗余特征
totaldf = pd.read_csv(r'D:/My thing/LIFE/Machine Learning/Data/totaldf.csv')
# 训练集对应标签
labeldf = pd.read_csv(r'D:/My thing/LIFE/Machine Learning/Data/labeldf.csv')
...
# %%time
# 保存处理好的数据
totaldf.to_csv(r'D:/My thing/LIFE/Machine Learning/数据清洗/totaldf-3.csv', index=False, encoding='utf-8')

# #特征选择
totaldf = pd.read_csv(r'D:/My thing/LIFE/Machine Learning/数据清洗/totaldf-3.csv')
...
features = [feature for feature in totaldf.columns if
            feature not in ['id', 'is_risk', 'year', 'min', 'op_ts', 'last_log1', 'last_log2']]
...
def feature_filter(df, labeldf):
    ...
    # fig.show()
    # 用于在本地展示，方便自己分析
    fig.write_html(r'D:/My thing/LIFE/Machine Learning/特征选择.html')
...
# 保存模型
joblib.dump(LGBMC, r'D:/My thing/LIFE/Machine Learning/建模/LGBMC-5.pkl')

# 读取模型
LGBMC = joblib.load(r'D:/My thing/LIFE/Machine Learning/建模/LGBMC-5.pkl')
...
submitdf.to_csv(r'D:/My thing/LIFE/Machine Learning/结果/submitdf-3.csv', index=False, encoding='utf-8')
submitdf.head()
"""
